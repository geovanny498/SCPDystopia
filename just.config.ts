...
const bundleTaskOptions: BundleTaskParameters = {
  entryPoint: path.join(__dirname, "./scripts/init.js"),
  external: ["@minecraft/server", "@minecraft/server-ui"],
  outfile: path.resolve(__dirname, "./dist/scripts/init.js"),
...
task(
  "local-deploy",
  watchTask(
    ["scripts/**/*.{ts,js}", "behavior_packs/**/*.{json,lang,png,mcfunction}", "resource_packs/**/*.{json,lang,png}"],
