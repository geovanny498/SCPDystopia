...
export const projectileConfig = {
  ...
  "lc:dt_p90_bullet_player_ads": { damage: 9, knockback: 0.04, pierce: 3 },
  "lc:dt_scar_bullet_player_sneak": { damage: 8, knockback: 0.04, pierce: 3 },
  "lc:dt_m4a1_bullet_player_sneak": { damage: 8, knockback: 0.04, pierce: 3 },
  "lc:dt_hk416_bullet_player_ads": { damage: 9, knockback: 0.04, pierce: 3 },

  // Jugador (20 de vida) Aplok Guns
  "lc:dt_mp7_player_bullet": { damage: 8, knockback: 0.04, pierce: 3 },
  "lc:dt_ak47_player_bullet": { damage: 8, knockback: 0.04, pierce: 3 },
  "lc:dt_p90_player_bullet": { damage: 9, knockback: 0.04, pierce: 3 },
  "lc:dt_dtrifle_player_bullet": { damage: 180, knockback: 0.04, pierce: 3 }, // awp
  "lc:dt_scar_player_bullet": { damage: 8, knockback: 0.04, pierce: 3 }, // m249
  "lc:dt_m4a1_player_bullet": { damage: 8, knockback: 0.04, pierce: 3 },
  "lc:dt_hk416_player_bullet": { damage: 9, knockback: 0.04, pierce: 3 }, // m4a1

  // Sin usar
  "lc:dt_suscharger_shot_player_sneak": { damage: 5, knockback: 0.02, pierce: 1 },
  "lc:dt_dtrifle_bullet_player_sneak": { damage: 180, knockback: 0.02, pierce: 1 },
