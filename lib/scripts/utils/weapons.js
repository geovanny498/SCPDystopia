...
function shoot(player, itemId) {
    ...
    try {
        ...
        debugWarn("player", `[DEBUG] Player id=${player.id}, typeId=${player.typeId}, location=(${player.location.x.toFixed(2)}, ${player.location.y.toFixed(2)}, ${player.location.z.toFixed(2)}), properties=${Object.getOwnPropertyNames(player).join(", ")}`, "blue");
        ...
        if (player.typeId === "minecraft:player") {
            ...
            if (equippable) {
                ...
                debugWarn("player", `[DEBUG] Player armadura: Head=${(helmet === null || helmet === void 0 ? void 0 : helmet.typeId) || "Ninguno"}, Chest=${(chest === null || chest === void 0 ? void 0 : chest.typeId) || "Ninguno"}, Legs=${(legs === null || legs === void 0 ? void 0 : legs.typeId) || "Ninguno"}, Feet=${(boots === null || boots === void 0 ? void 0 : boots.typeId) || "Ninguno"}`, "cyan");
            }
            else {
...
world.afterEvents.itemUse.subscribe((event) => {
    ...
    const item = (_b = (_a = player.getComponent("minecraft:inventory")) === null || _a === void 0 ? void 0 : _a.container) === null || _b === void 0 ? void 0 : _b.getItem(slot);
    if (!item)
        return;
    ...
    if (!data)
        return;
    if (data.isAutomatic) {
        if (firingPlayers.has(player.id))
            return;
        const intervalId = system.runInterval(() => {
            var _a;
            const inventory = (_a = player.getComponent("minecraft:inventory")) === null || _a === void 0 ? void 0 : _a.container;
            const currentItem = inventory === null || inventory === void 0 ? void 0 : inventory.getItem(player.selectedSlotIndex);
        ...
        const nextAllowedTick = (_c = cooldownMap.get(player.id)) !== null && _c !== void 0 ? _c : 0;
