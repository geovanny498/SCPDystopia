...
export function debugMessage(module, message, color = "gray") {
    ...
    if (!DEBUG_CONSOLE || !isModuleEnabled(module))
        return;
    const c = (_a = CONSOLE_COLORS[color.toLowerCase()]) !== null && _a !== void 0 ? _a : CONSOLE_COLORS.gray;
...
export function debugWarn(module, message, color = "yellow") {
    ...
    if (!DEBUG_CONSOLE || !isModuleEnabled(module))
        return;
    const c = (_a = CONSOLE_COLORS[color.toLowerCase()]) !== null && _a !== void 0 ? _a : CONSOLE_COLORS.yellow;
...
export function debugChat(module, message, color = "gray") {
    ...
    if (!DEBUG || !isModuleEnabled(module))
        return;
    const c = (_a = CHAT_COLORS[color.toLowerCase()]) !== null && _a !== void 0 ? _a : CHAT_COLORS.gray;
