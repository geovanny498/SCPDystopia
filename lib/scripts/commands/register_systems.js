        ...
        init.customCommandRegistry.registerCommand(setCmd, (origin) => {
            ...
            for (const [systemName, cfg] of Object.entries(defaultConfigs)) {
                ...
                if (systemName === "teleport") {
                    ...
                    systemStates.teleport.foundation = Object.assign({}, cfg.foundation);
                    systemStates.teleport.chaos = Object.assign({}, cfg.chaos);
                }
                else {
                    if (!systemStates[systemName])
                        systemStates[systemName] = {};
                    systemStates[systemName].foundation = Object.assign({}, cfg.foundation);
                    systemStates[systemName].chaos = Object.assign({}, cfg.chaos);
                }
            }
    ...
    try {
        init.customCommandRegistry.registerCommand(checkCmd, (origin) => {
            ...
            for (const sysId of systemIds) {
                ...
                let state;
                try {
                    state = JSON.parse(raw !== null && raw !== void 0 ? raw : "{}");
                }
                catch (_a) {
                    state = {};
                }
...
//# sourceMappingURL=register_systems.js.map