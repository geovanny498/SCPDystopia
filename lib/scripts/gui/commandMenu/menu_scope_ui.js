    ...
    try {
        ...
        system.run(() => {
            form.show(player).then(res => {
                debugWarn("menuScope", `ActionForm resultado: canceled=${res === null || res === void 0 ? void 0 : res.canceled}, selection=${res === null || res === void 0 ? void 0 : res.selection}`, "cyan");
                if (!res || res.canceled) {
...
function showFactionScopeMenu(player, faction) {
    try {
        ...
        subgroupIds.forEach(subgroupId => {
            ...
            const selectedCount = subgroup.units.filter(u => { var _a; return (_a = factionScope.specialUnits) === null || _a === void 0 ? void 0 : _a.includes(u); }).length;
...
function showSubgroupModal(player, faction, subgroupId) {
    try {
        ...
        subgroup.units.forEach(unitName => {
            var _a;
            const isSelected = ((_a = factionScope.specialUnits) === null || _a === void 0 ? void 0 : _a.includes(unitName)) || false;
...
//# sourceMappingURL=menu_scope_ui.js.map