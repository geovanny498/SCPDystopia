...
export function buildSystemForm(systems, loadedStates) {
    ...
    systems.forEach((system, index) => {
        ...
        factionOrder.forEach(faction => {
            ...
            const state = ((_a = loadedStates[system.id]) === null || _a === void 0 ? void 0 : _a[faction]) || system.defaults[faction];
            // Controles según el tipo
            if (system.controlType === ControlType.TOGGLE) {
                // Toggle para normales
                const normalValue = (_b = state.enable) !== null && _b !== void 0 ? _b : false;
                ...
                if (system.supportsSpecials) {
                    const specialValue = (_c = state.includeSpecial) !== null && _c !== void 0 ? _c : false;
                ...
                const normalValue = (_d = state.mode) !== null && _d !== void 0 ? _d : system.defaults[faction].mode;
                ...
                if (system.supportsSpecials) {
                    const specialValue = (_e = state.includeSpecial) !== null && _e !== void 0 ? _e : system.defaults[faction].includeSpecial;
        ...
        factionOrder.forEach(faction => {
            ...
            if (system.controlType === ControlType.TOGGLE) {
                ...
                const normalValue = typeof normalIndex === "number"
                    ? (_a = system.options[normalIndex]) === null || _a === void 0 ? void 0 : _a.value
                ...
                if (system.supportsSpecials) {
                    ...
                    const specialValue = typeof specialIndex === "number"
                        ? (_b = system.options[specialIndex]) === null || _b === void 0 ? void 0 : _b.value
