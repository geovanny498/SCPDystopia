...
export function getSystemEvents(systemId, value) {
    ...
    if (sys.controlType === ControlType.TOGGLE) {
        ...
        return ((_b = (_a = sys.events) === null || _a === void 0 ? void 0 : _a.enable) === null || _b === void 0 ? void 0 : _b[value]) ? { event: sys.events.enable[value] } : {};
    }
    else if (sys.controlType === ControlType.DROPDOWN) {
        // Para dropdown, buscar la opción por value
        const option = (_c = sys.options) === null || _c === void 0 ? void 0 : _c.find(opt => opt.value === value);
        return (option === null || option === void 0 ? void 0 : option.events) || {};
    }
    return {};
}
